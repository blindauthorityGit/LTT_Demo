...
<html lang="de">
  ...
  <body id="backendBody">
    ...
    <nav class="navbar navbar-dark fixed-top bg-light flex-md-nowrap p-0" style="background: white!important;">
          ...
          <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#"><img src="img/logo.png" alt="">  </a>
...
<!-----------------STAMMDATEN POPUP, soll Display: none sein, bei Click auf "Stammdaten bearbeiten" dann Display:block. Soll verschwinden bei Click ausserhalb des Containers---------->
    <div id="stammDatenDialogClickAway" class="stammDatenDialogClickAway">
        ...
        <div id="stammDatenDialog" class="classStammDatenContainer">
            ...
            <button id="saveStammDatenBtn" class="classSave2">Speichern</button>
...
<!-----------------STAMMDATEN POPUP ENDE ------------------------------>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 classMarginTop5em classPL5">

                    <div class="row">
                        <!---Fields -->
                        <div id="boxField" class="col-md-6">
...
<!---------------------------------------------------------LOGO UPLOAD -->
                            ...
                            <div class="classWrapper" style="display:none">
...
<!---------------------------------------------------------SAVE Button -->
                            <div class="row">
                                <div class="col text-center nopadding mtop1"><button id="saveBtn" class="classSave">Speichern</button> </div>
                           
                            </div>     <a id="signOutBtn" class="nav-link" href="#">Sign out</a>
