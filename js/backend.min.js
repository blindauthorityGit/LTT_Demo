function domReady() {
        ...
        if ("6" === type) {
          ...
          const inputA =
            ...
            inputB =
              nodeList[key].childNodes[0].childNodes[0].childNodes[4]
                .childNodes[0].value;
          request.boxes[i] = { type: type, inputA: inputA, inputB: inputB };
        }
        i++;
      }
    if (
  ...
  function addBox(box) {
    if (((box.placeholderA = "..."), (box.placeholderB = "..."), counter > 10))
    ...
    typeWrap.setAttribute("class", "col-md-11");
    ...
    "5" === box.type
      ? ("noName" === box.inputA
          ? ((inputA.placeholder = "kein Name vergeben"), (inputA.value = ""))
