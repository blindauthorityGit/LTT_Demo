function domReady() {
  function addBox(box) {
    ...
    outputA.setAttribute("class", "col-4 classTextTitle left");
    outputA.innerHTML = box.inputA;
    const outputB = document.createElement("div");
    outputB.setAttribute("class", "col classTextTitle right");
    outputB.innerHTML = box.inputB;
    // let outputB, outputBWrap, outputC;
    /*  switch (
      ...
      case "1":
          (outputC = document.createElement("div")).setAttribute(
            "class",
            "col-sm-4 classTextInput size"
          );
    ...
    "5" === box.type
      ...
      : (outputB.innerHTML = box.inputB),
      "1" !== box.type
        ? (outputBWrap.appendChild(outputB), boxWrap.appendChild(outputBWrap))
        : boxWrap.appendChild(outputB),
        */
    boxWrap.appendChild(outputA);
    boxWrap.appendChild(outputB);
  ...
  function setKontaktData(data) {
    (title.innerHTML = data.title),
      ...
      "" !== data.logo ? (logo.src = data.logo) : (logo.src = defaultLogo);
  }
